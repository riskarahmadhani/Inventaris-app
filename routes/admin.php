...
Route::get('peminjaman/pegawai/{pegawai}/empty', [
    PeminjamanAdminController::class, 'empty'
])->name('admin.peminjaman.empty');

Route::get('/peminjaman/{peminjaman}/info', [
    PeminjamanAdminController::class, 'info'
])->name('admin.peminjaman.info');

Route::get('/peminjaman/{peminjaman}/card', [
    PeminjamanAdminController::class, 'card'
])->name('admin.peminjaman.card');

Route::get('/peminjaman/{peminjaman}/status/{status}',
[PeminjamanAdminController::class, 'status'])
